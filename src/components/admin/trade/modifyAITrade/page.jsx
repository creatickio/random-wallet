...
function ModifyAITrade({ selectedTradeID, selectedUserTradeID, onSuccess }) {
  ...
  //   Update the AI Trade
  async function updateAITrade(event) {
    ...
    if (error) {
      ...
      toast.success("AI Trade updated successfully!", {
        position: "top-right",
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,

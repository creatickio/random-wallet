...
function Crypto({ crypto }) {
  ...
  return (
    <div className="max-w py-8 px-6 md:p-8 lg:p-12 bg-lightlightGray text-darkBlack border border-border rounded-xl">
      {/* top */}
      <div className="flex justify-between">
        <div className="flex gap-3">
          ...
          <div className="flex flex-col items-start">
            <h5 className="text-darkBlack text-2xl lg:text-[27px] font-medium">
              {crypto.name}
            </h5>
            {crypto.price ? (
              <>
        ...
        {/* explorer link */}
        <Link
          className="flex items-center justify-center bg-lightGray w-16 h-16 lg:w-[70px] lg:h-[70px] rounded-xl"
